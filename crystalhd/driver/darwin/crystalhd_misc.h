...
#define crystalhd_cancel_event(ev) thread_wakeup_with_result((event_t)ev, THREAD_INTERRUPTED)
...
#else
#define crystalhd_get_sgle_paddr(_dio, _ix) (_dio->sg[_ix].dma_address)
#define crystalhd_get_sgle_len(_dio, _ix) (_dio->sg[_ix].dma_length)
#endif
